...
interface MarketplaceClientProps {
  ...
  /** True average member saving across the catalogue, rounded — computed server-side. */
  ...
  return (
    <div style={{ background: "#1A0F0A", minHeight: "100vh" }}>
      <div className="max-w-6xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        {/* ── Member savings callout (real average) ────────────── */}
          ...
          >
            ...
            <p className="text-sm" style={{ color: "#C4A882" }}>
              ...
              <span style={{ color: "#D4A853", fontFamily: "var(--font-heading)", fontWeight: 600 }}>
                {averageSavingsPercent}% across every product
              </span>{" "}
        ...
        {filtered.length === 0 ? (
          ...
          >
            ...
            <p className="text-sm" style={{ color: "#C4A882" }}>
              New products are added as they pass review. Know one that belongs
              here? Submit it below.
            </p>
          </div>
        ) : (
